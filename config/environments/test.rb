...
GOO_HOST = ENV.include?("GOO_HOST") ? ENV["GOO_HOST"] : "localhost"
USE_DIGEST_AUTH  = ENV.include?("USE_DIGEST_AUTH")  ? ENV["USE_DIGEST_AUTH"]  : "false"
DB_USER          = ENV.include?("DB_USER")          ? ENV["DB_USER"]         : "dba"
DB_PASSWORD      = ENV.include?("DB_PASSWORD")      ? ENV["DB_PASSWORD"]     : "dba"
...
LinkedData.config do |config|
  ...
  config.goo_redis_host = REDIS_PERSISTENT_HOST.to_s
